...
if __name__ == '__main__':
    ...
    if sys.version_info[1] >= 7 or sys.version_info[0] > 2:
        ...
        parser.add_argument('wcs_templ', metavar='wcs_template',help='WCS Template File. The current data will be registered to this image. Full path is required.',default='')
        parser.add_argument('templ_date', metavar='template_date',help='Date of template epoch. Format is YYYYMMDD. This will automatically locate the correct template files to subtract from the current data. No subtraction will be completed if this is omitted.',default='')
        parser.add_argument('templ_file', metavar='template_file',help='Template image to subtract from the current data. Full path is required. This overrides the template_date.',default='')
        parser.add_argument('templ_instr', metavar='template_instrument',help='Template instrument. Default is the image instrument.',default='')
